...
public class Service implements IstSOSObject<Service>{
	 ...
	 * @param callback
	 */
	public void loadDatabase(IstSOSListener callback){
		...
		IstSOS.executeGet(Requests.getUrl(Request.DATABASE, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void validateDatabase(DatabaseConnection database, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.VALIDATE_DATABASE, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void loadProvider(IstSOSListener callback){

		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());
		
		IstSOS.executeGet(Requests.getUrl(Request.PROVIDER, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void updateProvider(Provider provider, IstSOSListener callback){
		...
		IstSOS.executePut(Requests.getUrl(Request.PROVIDER, urlKeyMap), data, new IstSOSListener(){
	...
	public void getObervation(Offering offering, Procedure procedure, ObservedProperty defUrn, 
		...
		IstSOS.executeGet(Requests.getUrl(Request.GETOBSERVATION, urlKeyMap), new IstSOSListener(){
	...
	public void getObervation(Offering offering, List<Procedure> procedure, 
					List<ObservedProperty> defUrn, Date beginPosition, Date endPosition, IstSOSListener callback){
	 ...
	 * @param callback
	 */
	public void describeSensor(String procedureName, IstSOSListener callback){
		...
		IstSOS.executeGet(Requests.getUrl(Request.PROCEDURE, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void registerSensor(Procedure procedure, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.PROCEDURE, urlKeyMap), data, new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void insertObservation(Procedure procedure, Observation observation, IstSOSListener callback){
	 ...
	 * @param callback
	 */
	public void loadStatus(IstSOSListener callback){
		
		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());

		IstSOS.executeGet(Requests.getUrl(Request.STATUS, urlKeyMap), new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void loadDataQualities(IstSOSListener callback){
		
		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());
		
		IstSOS.executeGet(Requests.getUrl(Request.DATA_QUALITIES, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void registerDataQuality(DataQuality dataQuality, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.DATA_QUALITIES, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void updateDataQuality(DataQuality dataQuality, IstSOSListener callback){
		...
		IstSOS.executePut(Requests.getUrl(Request.DATA_QUALITIES, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void removeDataQuality(DataQuality dataQuality, IstSOSListener callback){
		...
		IstSOS.executeDelete(Requests.getUrl(Request.DATA_QUALITIES, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void loadObservedProperties(IstSOSListener callback){
		
		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());
		
		IstSOS.executeGet(Requests.getUrl(Request.OBSERVED_PROPERTIES, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void registerObservedProperty(ObservedProperty observedProperty, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.OBSERVED_PROPERTIES, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void updateObservedProperty(ObservedProperty observedProperty, IstSOSListener callback){
		...
		IstSOS.executePut(Requests.getUrl(Request.OBSERVED_PROPERTIES, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void removeObservedProperty(ObservedProperty observedProperty, IstSOSListener callback){
		...
		IstSOS.executeDelete(Requests.getUrl(Request.OBSERVED_PROPERTIES, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void loadUnitsOfMeasure(IstSOSListener callback){
		
		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());
		
		IstSOS.executeGet(Requests.getUrl(Request.UOMS, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void registerUnitOfMeasure(UnitOfMeasure uom, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.UOMS, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void updateUnitOfMeasure(UnitOfMeasure uom, IstSOSListener callback){
		...
		IstSOS.executePut(Requests.getUrl(Request.UOMS, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void removeUnitOfMeasure(UnitOfMeasure uom, IstSOSListener callback){
		...
		IstSOS.executeDelete(Requests.getUrl(Request.UOMS, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void loadProcedures(IstSOSListener callback){
		
		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());
		
		IstSOS.executeGet(Requests.getUrl(Request.PROCEDURES, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param procedureName
	 */
	public void getProcedure(String procedureName, IstSOSListener callback){
	 ...
	 * @param callback
	 */
	public void registerProcedure(Procedure procedure, IstSOSListener callback){
	 ...
	 * @param callback
	 */
	public void updateProcedure(Procedure procedure, IstSOSListener callback){
		...
		IstSOS.executeDelete(Requests.getUrl(Request.PROCEDURE, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void loadVirtualProcedures(IstSOSListener callback){
		
		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());
		
		IstSOS.executeGet(Requests.getUrl(Request.VIRTUAL_PROCEDURES, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void loadVirtualProcedureCode(VirtualProcedure virtualProcedure, IstSOSListener callback){
		...
		IstSOS.executeGet(Requests.getUrl(Request.VIRTUAL_PROCEDURES_CODE, urlKeyMap), new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void registerVirtualProcedureCode(VirtualProcedure virtualProcedure, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.VIRTUAL_PROCEDURES_CODE, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void updateVirtualProcedureCode(VirtualProcedure virtualProcedure, IstSOSListener callback){
		...
		IstSOS.executePut(Requests.getUrl(Request.VIRTUAL_PROCEDURES_CODE, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void removeVirtualProcedureCode(VirtualProcedure virtualProcedure, IstSOSListener callback){
		...
		IstSOS.executeDelete(Requests.getUrl(Request.VIRTUAL_PROCEDURES_CODE, urlKeyMap), data, new IstSOSListener(){
	...
	public void loadVirtualProcedureRatingCurve(VirtualProcedure virtualProcedure, IstSOSListener callback){
		...
		IstSOS.executeGet(Requests.getUrl(Request.VIRTUAL_PROCEDURES_RATINGCURVE, urlKeyMap), new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void registerVirtualProcedureRatingCurve(VirtualProcedure virtualProcedure, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.VIRTUAL_PROCEDURES_RATINGCURVE, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void removeVirtualProcedureRatingCurve(VirtualProcedure virtualProcedure, IstSOSListener callback){
		...
		IstSOS.executeDelete(Requests.getUrl(Request.VIRTUAL_PROCEDURES_RATINGCURVE, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void loadOfferings(IstSOSListener callback){
		
		Map<String, String> urlKeyMap = new HashMap<String, String>();
		urlKeyMap.put("url", this.server.getServerUrl());
		urlKeyMap.put("name", this.getName());
		
		IstSOS.executeGet(Requests.getUrl(Request.OFFERINGS, urlKeyMap), new IstSOSListener() {
	 ...
	 * @param callback
	 */
	public void registerOffering(Offering offering, IstSOSListener callback){
		...
		IstSOS.executePost(Requests.getUrl(Request.OFFERINGS, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void updateOffering(Offering offering, IstSOSListener callback){
		...
		IstSOS.executePut(Requests.getUrl(Request.OFFERINGS, urlKeyMap), data, new IstSOSListener(){
	 ...
	 * @param callback
	 */
	public void removeOffering(Offering offering, IstSOSListener callback){
		...
		IstSOS.executeDelete(Requests.getUrl(Request.OFFERINGS, urlKeyMap), data, new IstSOSListener(){
